...
{	// returns false if any command has an error.
	...
	// priority 1 args are -A, -F, -J, -O, -Q, -V, -W, -X, -Z
...
void Ccmd_app::displayHelp(void)
{
	...
	printf("     http://kair.us/projects/pickit2minus/index.html\n");
}
...
{
	_TCHAR *partlist_array[1500];	// Increased from 1024 to 1500 15.6.2022 because device file now has more than 1024 parts
	int partNum, partIdx;
